...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/lucianocorreia/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/Users/lucianocorreia/.local/share/nvim/site/pack/packer/start/gruvbox-material",
